...
const values = [
  ...
  { icon: Truck, title: "التوصيل السريع", desc: "نوفر خدمة توصيل سريعة لجميع المدن اليمنية" },
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="card p-6 md:p-10 mb-8">
        ...
        <div className="space-y-6 text-slate-600 leading-relaxed" dir="rtl">
          <p>
            <strong className="text-slate-800">خبور</strong> هي منصة تجارة إلكترونية يمنية تأسست بهدف توفير تجربة تسوق متميزة وموثوقة. نجمع بين التكنولوجيا المتقدمة وخدمة العملاء الممتازة لنقدم لك أفضل تجربة شراء عبر الإنترنت.
          </p>
          <p>
