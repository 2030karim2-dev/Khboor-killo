...
const faqs = [
  ...
  },
  {
    ...
    a: "نوفر الدفع عبر البطاقات الئتمانية (فيزا / ماستركارد) والدفع عند الاستلام. جميع المعاملات آمنة ومشفرة.",
  },
  {
    q: "كم تستغرق عملية التوصيل؟",
    a: "تختلف مدة التوصيل حسب المدينة.一般来说، التوصيل داخل الرياض خلال 1-2 يوم عمل، والمدن الأخرى 2-5 أيام عمل.",
  },
  {
    q: "هل الشحن مجاني؟",
  ...
  {
    q: "هل بياناتي آمنة؟",
    a: "نعم، نحمي بياناتك بأعلى معايير الأمان. نستخدم تشفير SSL ولا نخزن معلومات بطاقتك الئتمانية. راجع سياسة الخصوصية لمزيد من التفاصيل.",
  },
  {
